...
export default function ProfileScreen() {
    ...
    // Inline style overrides to enforce yellow theme
    const yellowThemeStyle = {
        '--tw-text-opacity': '1',
        'color': 'rgb(249 245 6 / var(--tw-text-opacity, 1))'
    ...
    return (
        <div className="profile-page bg-[#f8f8f5] dark:bg-[#23220f] font-spline antialiased min-h-screen flex flex-col transition-colors duration-300">
            <header className="w-full px-6 py-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-[#2c2b15]/80 backdrop-blur-sm sticky top-0 z-10">
                ...
                <div className="w-full max-w-[540px] bg-white dark:bg-[#2c2b15] rounded-lg shadow-xl border border-gray-100 dark:border-gray-800 flex flex-col overflow-hidden animate-fade-in-up">
                    ...
                    <div className="p-6 sm:p-8 flex flex-col gap-8 overflow-y-auto max-h-[80vh]">
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <div className="text-center"><p className="text-gray-900 dark:text-white text-lg font-bold">AlexReader</p><p className="text-gray-500 dark:text-gray-400 text-sm">Member since 2023</p></div>
                        </div>
                        <form className="flex flex-col gap-6" onSubmit={(e)=>e.preventDefault()}>
                            <div className="flex flex-col gap-2">
                                <label className="text-gray-700 dark:text-gray-200 text-sm font-semibold ml-1">Nickname</label>
                                <div className="relative">
                                    <input className="w-full bg-[#f8f8f5] dark:bg-[#23220f] border-transparent focus:border-[#f9f506] focus:ring-0 rounded-xl px-5 py-3.5 text-gray-900 dark:text-white placeholder-gray-400 transition-all outline-none font-medium" type="text" defaultValue="AlexReader"/>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative opacity-70">
                                    <input className="w-full bg-gray-100 dark:bg-gray-800/50 border-transparent rounded-xl px-5 py-3.5 text-gray-500 dark:text-gray-400 cursor-not-allowed font-medium" disabled readOnly type="email" defaultValue="alex@example.com"/>
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <details className="group bg-[#f8f8f5] dark:bg-[#23220f] rounded-xl overflow-hidden transition-all duration-300">
                                    ...
                                    <div className="p-4 pt-0 flex flex-col gap-4 animate-fade-in"><div className="mt-4"><input className="w-full bg-white dark:bg-[#2c2b15] border border-gray-200 dark:border-gray-700 focus:border-[#f9f506] focus:ring-1 focus:ring-[#f9f506] rounded-xl px-4 py-3 text-gray-900 dark:text-white" placeholder="Current Password" type="password"/></div></div>
                                </details>
                            </div>
                        </form>
                    </div>
                    <div className="p-6 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row gap-4 items-center justify-between bg-gray-50/50 dark:bg-gray-900/20">
                        <button onClick={()=>router.push('/')} className="text-sm font-semibold text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400 transition-colors" type="button">Sign Out</button>
                        <div className="flex gap-3 w-full sm:w-auto">
                            ...
                            <button onClick={()=>router.push('/dashboard')} className="flex-1 sm:flex-none px-8 py-3 rounded-full bg-[#f9f506] text-black font-bold text-sm shadow-lg shadow-[#f9f506]/20 hover:shadow-[#f9f506]/40 hover:scale-[1.02] active:scale-[0.98] transition-all" type="button">Save Changes</button>
                        </div>
                    </div>
                </div>
            </main>
